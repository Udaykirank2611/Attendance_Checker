...
# --- DYNAMIC CSS LOADING (FIXED BUTTONS) ---
...
<style>
    ...
    /* === FIX: BUTTON STYLING === */
    /* Forces white text even in light mode for the gradient button */
    div.stButton > button {{
        width: 100%;
    ...
    /* Ensure inner paragraph text is also white */
...
def create_donut_chart(attended, bunked, remaining):
    ...
    # Update layout text color based on theme
...
if st.session_state.calculated:
    ...
    if class_attended > class_held:
        ...
        if current_pct >= 85:
            ...
            meme_url = "https://media.giphy.com/media/3o7TKr3nzbh5WgCFxe/giphy.gif"
            meme_caption = "Sweating bullets! 💸"
        else:
